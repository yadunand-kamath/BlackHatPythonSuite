def argument_parser:
    # Allow user to specify target host and property
...
def send_email(server, port, username, password, send_from, send_to, message, tls):
    # Send the email to email server
...
# Use app.sendgrid.com -> smtp.sendgrid.net 25 apikey ********** test_email.html https://www.woot.com "You've Won" "from-email_address" "to-email_address"
